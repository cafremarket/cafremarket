          ...
          <div class="neckbands-header">
            <div class="sell-header mb-3">
              ...
              <div class="best-deal-arrow">
                <ul>
                  <li><button type="button" class="left-arrow slider-arrow slick-arrow featured-categories-left" aria-label="left arrow"><i class="fal fa-chevron-left"></i></button></li>
                  <li><button type="button" class="right-arrow slider-arrow slick-arrow featured-categories-right" aria-label="right arrow"><i class="fal fa-chevron-right"></i></button></li>
                </ul>
              </div>
            </div>
          </div>
