          ...
          <div class="neckbands-header">
            <div class="sell-header mb-3">
              ...
              <div class="best-deal-arrow">
                <ul>
                  <li><button class="left-arrow slider-arrow slick-arrow neckbands-left" aria-label="{{ trans('theme.previous') }}"><i class="fal fa-chevron-left"></i></button></li>
                  <li><button class="right-arrow slider-arrow slick-arrow neckbands-right" aria-label="{{ trans('theme.next') }}"><i class="fal fa-chevron-right"></i></button></li>
                </ul>
              </div>
            </div>
