        ...
        <div class="row">
          <div class="col-md-8">
            ...
            @if (is_incevio_package_loaded('otp-login'))
              <div class="form-group">
                {!! Form::label('phone', trans('packages.otp-login.phone') . '*', ['class' => 'col-sm-4 control-label']) !!}
                <div class="col-md-8 col-sm-12">
                  {!! Form::text('phone', null, ['class' => 'form-control', 'placeholder' => trans('packages.otp-login.valid_phone'), 'id' => 'phone', 'required']) !!}
                  <div class="help-block with-errors"></div>
                </div>
              </div>
            @endif
