<div class="col-md-12 my-5">
  <div class="panel panel-default">
    <div class="panel panel-heading">
      <h3 class="panel-title">{{ trans('packages.wallet.deposit_fund') }}</h3>
          ...
          <div class="panel-body">
            <div class="form-group mb-3">
              <div class="input-group">
                ...
                {!! Form::number('amount', null, ['id' => 'amount', 'class' => 'form-control input-lg', 'step' => 'any', 'min' => 1, 'placeholder' => trans('packages.wallet.amount'), 'required' => 'required']) !!}
