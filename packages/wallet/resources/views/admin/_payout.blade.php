  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="form-group">
        ...
        {!! Form::select('shop_id', $shops, null, ['class' => 'form-control select2', 'width' => '100%', 'placeholder' => trans('packages.wallet.select'), 'required']) !!}
        <div class="help-block with-errors"></div>
      </div>

      <div class="form-group">
        {!! Form::label('order', trans('packages.wallet.payout_amount')) !!}
        <div class="input-group">
          ...
          @endif
          {!! Form::number('amount', 0, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('packages.wallet.payout_amount'), 'required']) !!}
      ...
      <div class="form-group">
        {!! Form::label('order', trans('packages.wallet.payout_fee')) !!}
        <div class="input-group">
          @if (get_currency_prefix())
            <span class="input-group-addon">
              {{ get_currency_prefix() }}
