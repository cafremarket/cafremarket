  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="form-group mt-2 mb-4">
        ...
        <p>{{ $transaction->payable->pay_to ?? trans('app.payout_instruction_not_available') }}</p>
      </div>
      ...
      <div class="form-group mt-2">
        ...
        <div class="help-block with-errors">{!! trans('packages.wallet.this_amount_will_charge') !!}</div>
      </div>
    </div>
