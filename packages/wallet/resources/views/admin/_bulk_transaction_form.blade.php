<div class="modal-dialog modal-md">
  <div class="modal-content">
    {!! Form::open(['route' => 'admin.wallet.bulkupload.review', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
    ...
    <div class="modal-body">
      <ul>
        ...
        <li>{!! trans('help.download_template', ['url' => route('admin.wallet.bulkupload.downloadTemplate')]) !!}</li>
        <li>{!! trans('help.first_row_as_header') !!}</li>
        <li>{!! trans('help.required_fields_csv', ['fields' => 'email, amount, currency_code, user_type']) !!}</li>
      ...
      <div class="row">
        ...
        <div class="col-md-3 nopadding-left">
          <div class="fileUpload btn btn-primary btn-block btn-flat">
            ...
            <input type="file" name="walletbulk" id="uploadBtn" class="upload" />
          </div>
        </div>
      </div>
    </div>
