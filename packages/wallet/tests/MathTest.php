...
class MathTest extends TestCase
{
     ...
     */
    public function test_abs(string $class): void
    {
        /**
     ...
     * @dataProvider dataProvider
     */
    public function test_compare(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_add(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_sub(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_div(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_mul(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_pow(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_ceil(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_floor(string $class): void
    {
        /**
         * @var Mathable $provider
         */
     ...
     * @dataProvider dataProvider
     */
    public function test_round(string $class): void
    {
        /**
         * @var Mathable $provider
         */
