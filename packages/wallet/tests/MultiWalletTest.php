...
class MultiWalletTest extends TestCase
{
    ...
    public function testInvalidDeposit(): void
    {
        ...
        $this->expectExceptionMessageStrict(trans('packages.wallet.price_positive'));
    ...
    public function testWithdraw(): void
    {
        ...
        $this->expectExceptionMessageStrict(trans('packages.wallet.wallet_empty'));
    ...
    public function testTransfer(): void
    {
        ...
        self::assertEquals($transfer->status, TransferStatuses::STATUS_TRANSFER);
    ...
    public function testWalletUnique(): void
    {
        ...
        if (DbService::connection() instanceof PostgresConnection) {
