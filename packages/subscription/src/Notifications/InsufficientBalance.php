...
class InsufficientBalance extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject(trans('packages.subscription.insufficient_balance.subject'))
            ->markdown(
    ...
    {
        return [
            //'message' => trans('packages.subscription.insufficient_balance.message', ['amount' => get_formated_currency($this->shop->wallet->balance, 2)]),
        ];
    }
}
