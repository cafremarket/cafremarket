...
class ExpireSoonNotice extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject(trans('packages.subscription.expire.subject', ['day' => $this->expire_date->diffInDays(Carbon::now())]))
            ->markdown(
    ...
    {
        return [
            //'expire_date' => trans('packages.subscription.expire.expire_date', ['date' => $this->expire_date])
        ];
    }
}
