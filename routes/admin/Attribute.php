...
// Translation Routes
Route::get('attribute/translate/{attribute}/{language}', [
    AttributeController::class, 'showTranslationForm',
])->name('attribute.translate.form');

Route::post('attribute/translate/{attribute}', [
    AttributeController::class, 'storeTranslation',
])->name('attribute.translate.store');
