...
class OrderResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'transaction_fee_raw' => '0',
            'total_paid' => get_formated_currency($this->grand_total, $decimal, $this->currency_id),
            'total_paid_raw' => strval(round((float) $this->grand_total, $decimal)),
                ...
                function () {
                    return $this->attachments->map(function ($attachment) {
                        return [
                            ...
                            'url' => route('attachment.download', $attachment),
                        ];
                    })->values();
                }
            ),
            'wire_transfer_proof' => $this->when(
                ...
                function () {
                    return [
                        ...
                        'path' => $this->wire_transfer_proof_path,
                    ];
                }
            ),
        ];
