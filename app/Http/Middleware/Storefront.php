...
class Storefront
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        // Same country/state lists as InventorySearch (search results) for header search + zone filter.
        ...
        View::share('searchCountries', $searchCountries);
        View::share('searchStates', ListHelper::states($defaultCountryId));
