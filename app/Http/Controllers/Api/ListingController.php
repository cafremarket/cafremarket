...
class ListingController extends Controller
{
    ...
    public function item(Request $request, $slug)
    {
        ...
        $states = $ship_to_country_id ? State::where('country_id', $ship_to_country_id)
            ->orderBy('name', 'asc')->get() : null;
     ...
     *
     * @param  string  $slug  item_slug
     * @return ItemLightResource|\Illuminate\Http\Response
     */
