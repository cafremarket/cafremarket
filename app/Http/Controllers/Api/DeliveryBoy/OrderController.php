...
use App\Http\Requests\DeliveryBoy\ConfirmDeliveryRequest;
use App\Http\Requests\DeliveryBoy\MarkReachedRequest;
...
class OrderController extends Controller
{
    ...
    /**
     * Rider has reached the customer's location. Generates a fresh OTP,
     * shown to the customer (never returned to the rider) for delivery confirmation.
     */
    ...
    /**
     * Verify the OTP the customer read out to the rider and, on match,
