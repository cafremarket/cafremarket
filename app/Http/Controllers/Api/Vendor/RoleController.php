...
class RoleController extends Controller
{
    ...
    public function store(CreateRoleRequest $request)
    {
        ...
        return response()->json(['message' => trans('api.role_created_successfully')], 200);
    }
    ...
    public function update(Request $request, $role_id)
    {
        ...
        return response()->json(['message' => trans('api.role_updated_successfully')], 200);
    }
    ...
    public function trash(Request $request, $role_id)
    {
        ...
        return response()->json(['message' => trans('api.role_trashed_successfully')], 200);
    }
    ...
    public function restore(Request $request, $role_id)
    {
        ...
        return response()->json(['message' => trans('api.role_restored_successfully')], 200);
    }
    ...
    public function destroy(Request $request, $role_id)
    {
        ...
        return response()->json(['message' => trans('api.role_deleted_successfully')], 200);
    }
}
