...
class SupplierController extends Controller
{
    ...
    public function store(CreateSupplierRequest $request)
    {
        ...
        return response()->json(['message' => trans('api.supplier_created_successfully')], 200);
    }
    ...
    public function update(UpdateSupplierRequest $request, $id)
    {
        ...
        return response()->json(['message' => trans('api.supplier_updated_successfully')], 200);
    }
    ...
    public function trash($id)
    {
        ...
        return response()->json(['message' => trans('api.supplier_trashed_successfully')], 200);
    }
    ...
    public function restore($id)
    {
        ...
        return response()->json(['message' => trans('api.supplier_restored_successfully')], 200);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['message' => trans('api.supplier_deleted_successfully')], 200);
    }
}
