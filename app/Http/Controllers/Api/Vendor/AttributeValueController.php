...
class AttributeValueController extends Controller
{
    ...
    public function store(CreateAttributeValueRequest $request)
    {
        ...
        return response()->json(['message' => trans('api.attribute_value_created_successfully')], 200);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['message' => trans('api.attribute_value_updated_successfully')], 200);
    }
    ...
    public function trash($id)
    {
        ...
        return response()->json(['message' => trans('api.attribute_value_trashed_successfully')], 200);
    }
    ...
    public function restore($id)
    {
        ...
        return response()->json(['message' => trans('api.attribute_value_restored_successfully')], 200);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['message' => trans('api.attribute_value_deleted_successfully')], 200);
    }
}
