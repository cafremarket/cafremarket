...
class TaxController extends Controller
{
    ...
    public function store(CreateTaxRequest $request)
    {
        ...
        return response()->json(['message' => trans('api.tax_created_successfully')], 200);
    }
    ...
    public function update(UpdateTaxRequest $request, $id)
    {
        ...
        return response()->json(['message' => trans('api.tax_updated_successfully')]);
    }
    ...
    public function trash($id)
    {
        ...
        return response()->json(['message' => trans('api.tax_trashed_successfully')]);
    }
    ...
    public function restore($id)
    {
        ...
        return response()->json(['message' => trans('api.tax_restored_successfully')]);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['message' => trans('api.tax_deleted_successfully')]);
    }
}
