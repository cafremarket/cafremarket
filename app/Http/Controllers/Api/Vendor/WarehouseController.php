...
class WarehouseController extends Controller
{
    ...
    public function store(CreateWarehouseRequest $request)
    {
        ...
        return response()->json(['message' => trans('api.warehouse_created_successfully')], 200);
    }
    ...
    public function update(UpdateWarehouseRequest $request, $id)
    {
        ...
        return response()->json(['message' => trans('api.warehouse_updated_successfully')], 200);
    }
    ...
    public function trash($id)
    {
        ...
        return response()->json(['message' => trans('api.warehouse_trashed_successfully')], 200);
    }
    ...
    public function restore($id)
    {
        ...
        return response()->json(['message' => trans('api.warehouse_restored_successfully')], 200);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['message' => trans('api.warehouse_destroyed_successfully')], 200);
    }
}
