...
class LanguageController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function create(AdminOnlyAccessRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AdminOnlyAccessRequest $request, Language $language)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function trash(AdminOnlyAccessRequest $request, Language $language)
    {
        if (config('app.demo') == true && $language->id <= config('system.demo.langs', 4)) {
            return back()->with('warning', trans('messages.demo_restriction'));
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function restore(AdminOnlyAccessRequest $request, $id)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AdminOnlyAccessRequest $request, $id)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function massTrash(AdminOnlyAccessRequest $request)
    {
