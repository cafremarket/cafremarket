...
class NewMessage extends Notification implements ShouldQueue
{
    ...
    public function via($notifiable)
    {
        ...
        // Prevent live chat requests from blocking on SMTP when queue driver is sync.
        // Mail will still work when using async queue workers.
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->markdown('admin.mail.chat.new_message', [
                'url' => route('admin.support.chat_conversation.show', $this->repliable->id),
                'receipent' => $this->recipent,
                'message' => $this->text,
            ]);
    }
