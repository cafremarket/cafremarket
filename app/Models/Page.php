...
class Page extends BaseModel
{
    ...
    const PAGE_TNC_FOR_CUSTOMER = 'terms-of-use-customer';      // Terms and condition page for customers

    const PAGE_TNC_FOR_MERCHANT = 'terms-of-use-merchant';      // Terms and condition page for merchants
