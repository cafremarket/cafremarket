...
trait Attachable
{
    ...
    {
        return isset($this->attachments_count) ? $this->attachments_count : $this->attachments()->count();
    }
    ...
    {
        // Persist bytes on the configured filesystem disk; DB only stores the returned path + meta.
