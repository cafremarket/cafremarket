...
return [
    'wallet' => [
        ...
        'deposit_description' => 'Depósito na Cafre-pay usando :payment_method',
        ...
        'all_active_wallets' => 'Todas as carteiras ativas',
        'with_balance' => 'Com saldo',
        'all_types' => 'Todos os tipos',
        'topup_wallet' => 'Recarregar carteira',
        'wallet_logs' => 'Registos da carteira',
        'admin_topup_description' => 'Recarga manual pelo administrador',
        'admin_topup_success' => 'Carteira recarregada com sucesso.',
        'search_wallet' => 'Pesquisar por nome ou email',
        ...
        'pay_now' => 'Pagar agora',
        'required_when_mpesa' => 'obrigatório ao pagar com M-Pesa',
        'required_when_emola' => 'obrigatório ao pagar com eMola',
        ...
        'platform_fees_updated' => 'As definições de taxas de levantamento foram atualizadas.',
        'platform_fees_section_help' => 'Taxa ao aprovar um pedido de pagamento (levantamento) ao vendedor. As taxas de venda (taxa de transação e comissão do marketplace) definem-se em cada plano de subscrição.',
        'sales_fees_from_subscription_help' => 'As taxas da encomenda usam o <strong><a href=":url">plano de subscrição</a></strong> do vendedor: <strong>Taxa de transação</strong> (fixa, cobrada ao cliente no M-Pesa / eMola) e <strong>Comissão do marketplace</strong> (% deduzida ao vendedor quando a venda é creditada). Cada loja deve ter um plano ativo em Faturação.',
        'vendor_sales_require_subscription' => 'Esta loja não pode receber encomendas até o vendedor escolher um plano de subscrição (Conta → Faturação).',
        'sales_commission_on_sale_note' => 'A comissão do marketplace é deduzida quando cada encomenda paga é creditada na carteira (plano de subscrição da loja). Não é cobrada de novo no levantamento.',
        'platform_fee_enabled' => 'Ativar taxa',
        'platform_fee_type' => 'Tipo de taxa',
        'platform_fee_type_flat' => 'Valor fixo (MZN)',
        'platform_fee_type_percent' => 'Percentagem (%)',
        'platform_fee_value' => 'Valor da taxa',
        'platform_fee_mpesa_customer' => 'M-Pesa — parte gateway da taxa de transação (cliente)',
        'platform_fee_emola_customer' => 'eMola — parte gateway da taxa de transação (cliente)',
        'platform_fee_mpesa_vendor' => 'M-Pesa — parte gateway da comissão do marketplace (vendedor)',
        'platform_fee_emola_vendor' => 'eMola — parte gateway da comissão do marketplace (vendedor)',
        'platform_fee_payout_vendor' => 'Taxa de pagamento ao vendedor',
        'platform_fee_withdrawal_vendor' => 'Levantamento — taxa da plataforma ao vendedor',
        'payout_fee_auto_help' => 'Preenchido automaticamente nas definições quando a taxa de pagamento está ativa. Pode alterar antes de aprovar.',
        'payout_sales_commission_already_deducted' => 'A comissão do marketplace é deduzida em cada venda quando o valor entra na carteira. O levantamento usa apenas o saldo disponível.',
        'payout_approval_fee_help' => 'Taxa de transferência opcional. A comissão de vendas já foi deduzida em cada pagamento — deixe 0 salvo se cobrar uma taxa de levantamento separada.',
        'wallet_topup_fee_summary' => 'Resumo do pagamento',
        'wallet_topup_credit_amount' => 'Crédito na carteira',
        'wallet_topup_platform_fee' => 'Taxa de transação',
        'wallet_topup_total_charge' => 'Valor a pagar (M-Pesa / eMola)',
        'wallet_topup_fee_help' => 'A taxa de transação (gateway) é adicionada ao pagamento no telemóvel. A carteira é creditada com o valor que introduziu acima.',
        'checkout_payment_fee_summary' => 'Resumo do pagamento',
        'checkout_order_total' => 'Total da encomenda',
        'checkout_you_will_pay' => 'Valor a pagar (M-Pesa / eMola)',
        'checkout_mobile_pay_amount' => 'Valor a pagar (M-Pesa / eMola)',
        'checkout_customer_platform_fee' => 'Taxa de transação',
        'checkout_vendor_platform_fee' => 'Comissão do marketplace',
        'checkout_vendor_receives' => 'Vendedor recebe na carteira',
        'checkout_seller_platform_fee' => 'Comissão do marketplace (deduzida ao vendedor)',
        'checkout_platform_fee_help' => 'No M-Pesa ou eMola paga o total da encomenda mais a taxa de transação (plano de subscrição + taxa gateway). Ao vendedor é deduzida a comissão do marketplace (percentagem do plano + taxa gateway) quando a venda é creditada na carteira.',
        'checkout_platform_fee_help_customer' => 'No M-Pesa ou eMola paga o total da encomenda mais qualquer taxa de transação.',
        'payment_method_fee_admin_title' => 'Onde configurar as taxas de transação',
        'payment_method_fee_admin_checkout' => 'As taxas de venda no checkout (M-Pesa / eMola) vêm do <a href=":url">plano de subscrição</a> de cada vendedor (fixa ou percentagem). Carrinhos multi-vendedor somam as taxas por loja.',
        'payment_method_fee_admin_topup' => 'As taxas de recarga Cafre-pay / carteira são definidas em <a href=":url">Definições da carteira</a> (taxas gateway M-Pesa / eMola).',
        'checkout_vendor_fee_help' => 'A comissão do marketplace e as taxas gateway móvel são deduzidas desta venda quando a encomenda for creditada na sua carteira.',
        'payout_method' => 'Método de pagamento',
        'payout_method_bank_transfer' => 'Transferência bancária',
        'payout_method_mpesa' => 'M-Pesa',
        'payout_method_emola' => 'eMola',
        'payout_bank_name' => 'Nome do banco',
        'payout_account_holder' => 'Titular da conta',
        'payout_account_number' => 'Número da conta',
        'payout_mobile_number' => 'Número de telemóvel',
        'payout_mobile_help' => 'Use o número registado no M-Pesa ou eMola (ex.: 258XXXXXXXXX).',
        'payout_account' => 'Conta de pagamento',
        'payout_account_registered' => 'A sua conta de pagamento registada',
        'payout_account_not_registered' => 'Ainda não registada (definida no primeiro pedido de levantamento)',
        'payout_account_locked_help' => 'Por segurança, todos os levantamentos são enviados para esta conta e ela não pode ser alterada no seu painel. Para a alterar, contacte o suporte.',
        'payout_account_contact_support' => 'Contactar o suporte',
        'payout_account_first_time_notice' => 'Verifique bem estes dados. Esta conta ficará guardada como a sua conta de pagamento fixa e todos os levantamentos futuros serão enviados para ela. Só o suporte a poderá alterar depois.',
        'payout_account_locked_since' => 'Bloqueada desde :date',
        'payout_account_reset' => 'Repor conta de pagamento',
        'payout_account_reset_help' => 'Faça isto apenas depois de o vendedor pedir e confirmar a alteração através do suporte. O próximo levantamento registará a nova conta.',
        'payout_account_reset_done' => 'A conta de pagamento de :shop foi reposta. O próximo pedido de levantamento registará a nova conta.',
        'payout_mobile_invalid' => 'Introduza um número :method válido começado por :prefixes (ex.: 258XXXXXXXXX).',
        'payout_saved_instruction' => 'Dados de pagamento guardados',
        'payout_commission_summary' => 'Resumo do pedido de pagamento',
        'payout_requested_amount' => 'Valor solicitado',
        'payout_marketplace_commission' => 'Comissão do marketplace',
        'payout_total_wallet_debit' => 'Total deduzido da carteira',
        'payout_commission_help' => 'A comissão do marketplace é cobrada quando o administrador aprovar este pedido, além do valor solicitado.',
        'sale_credit_after_commission' => 'Venda :order (taxas da plataforma :commission deduzidas — líquido creditado na carteira)',
        'wallet_topup_complete_charge' => 'Conclua o pagamento no telemóvel: :total (inclui :fee de taxa). A carteira será creditada com :credit.',
        'back_to_wallet' => 'Voltar à carteira',
        'poll_timeout_error' => 'O pagamento não foi confirmado a tempo. Se já pagou, o saldo será atualizado quando recebermos a confirmação. Caso contrário, tente novamente ou contacte o suporte.',
        ...
        'payout_payment_proof_help' => 'Carregue o recibo ou confirmação da transferência (JPG, PNG ou PDF, máx. 10 MB).',
        'payout_payment_proof_required' => 'Carregue o comprovativo de pagamento antes de aprovar.',
        'payout_payment_proof_mimes' => 'O comprovativo deve ser JPG, PNG ou PDF.',
        'payout_payment_proof_download' => 'Descarregar comprovativo',
        'payout_fee' => 'Taxa de pagamento',
        'payout_fee_may_apply' => 'Pode ser aplicada uma taxa de pagamento pela :platform',
        'platform_fee' => 'Taxa de transação',
        ...
        'checking_status' => 'A verificar o estado do pagamento…',
        ...
        'desputed_amount' => 'Valor em disputa',
        'detail' => 'Detalhe',
        'today' => 'Hoje',
        'wallet_module_not_active' => 'O módulo de carteira não está ativo',
        'create_wallet_success' => 'Carteira pronta para :owner (saldo :balance).',
        'create_wallet' => 'Criar carteira',
        'create_wallet_help' => 'Crie uma carteira Cafrepay para um cliente ou loja através do email. Se já existir uma carteira, será reutilizada.',
        'wallet_topup_fees_section' => 'Taxas de gateway para carregamento da carteira',
        'wallet_topup_fees_help' => 'Quando um cliente ou vendedor adiciona dinheiro via M-Pesa ou eMola, cobrar esta taxa sobre o valor do depósito (configurada abaixo). A comissão do marketplace sobre as vendas é definida em cada plano de subscrição.',
        'platform_fee_mpesa_topup' => 'Taxa de carregamento da carteira M-Pesa',
        'platform_fee_emola_topup' => 'Taxa de carregamento da carteira eMola',
        'platform_fee_percent_hint' => 'use 2.5 para 2,5%.',
        'platform_fee_flat_hint' => 'valor fixo em MZN por transação.',
        'deposit_label' => 'Depósito',
        'withdraw_label' => 'Levantamento',
        'invalid_cart_parts' => 'Artigos do carrinho inválidos.',
        'amount_required_without_carts' => 'O valor é obrigatório quando não são indicados carrinhos.',
    ],
    'inspector' => [
        'filter' => 'Filter',
        ...
        'blocked' => 'Blocked',
        'inspection' => 'Inspeção',
        'inspector_settings' => 'Definições do inspetor',
        ...
        'attempt' => 'Attempts',
        'option' => 'Options',
        'inspectables' => 'Itens inspecionáveis',
    ...
    'subscription' => [
        ...
        'custom_subscription_fee' => 'Taxa de subscrição personalizada',
        'custom_subscription_fee_amount' => 'Custom subscription fee :amount',
        'custom_subscription_fee_help_text' => 'Se definida, o sistema ignora a taxa do plano de subscrição e cobra esta taxa personalizada a este vendedor.',
        'subscription_fee' => 'Taxa de subscrição do plano :subscription.',
        'subscription_fee_for' => 'Taxa de subscrição do plano :subscription (:from - :to).',
        'thanks' => 'Obrigado',
        'button_text' => 'Visitar o seu perfil',
        'greeting' => 'Olá :shop',
        'expire' => [
            'subject' => 'A subscrição da loja expira dentro de :day dias',
            'message' => 'Mantenha saldo suficiente na carteira da loja para ter um serviço sem interrupções.',
            'expire_date' => 'Data de expiração: :date',
        ],
        'billing_failed' => [
            'subject' => 'Falha na faturação da subscrição',
            'message' => 'A faturação da subscrição falhou por saldo insuficiente. Deposite saldo na carteira para renovar a sua subscrição',
            'expire_date' => 'Data de expiração: :date',
        ],
        'insufficient_balance' => [
            'subject' => 'Saldo insuficiente',
            'message' => 'O saldo atual da sua carteira está baixo. Deposite saldo na carteira para manter a subscrição; o seu saldo atual é :amount',
            'expire_date' => 'Data de expiração: :date',
        ],
    ],
    'checkout' => [
        ...
        'checkout_all_not_possible' => 'Um ou mais pedidos não podem ser processados em conjunto! Verifique os locais de entrega e as restantes informações.',
    ...
    'dynamicCommission' => [
        ...
        'commissions_settings' => 'Comissões',
        'custom_commission_rate' => 'Taxa de comissão personalizada',
        'custom_commission_percent' => 'Custom commission rate :percent%',
        'custom_commission_rate_help_text' => 'Se definida, o sistema usa esta taxa personalizada para cobrar a comissão do marketplace a este vendedor.',
        ...
        'periodic_sold_amount' => 'Valor vendido no período',
    ...
    'apple-login' => [
        'login_with_apple' => 'Iniciar sessão com a Apple',
        'apple' => 'Apple',
    ],
    'paypal-marketplace' => [
    ...
    'trendingKeywords' => [
        'trending_keywords' => 'Pesquisas em tendência',
    ...
    'otp-login' => [
        'phone' => 'Telefone',
        'valid_phone' => 'Introduza um número de telefone válido',
        'not_registered' => 'Número ainda não registado',
        ...
        'back' => 'BACK',
        'resend' => 'RESEND',
        'phone_session_expired' => 'A sua sessão expirou! Introduza novamente o número de telefone.',
        ...
        'verification_code_sent' => 'O código de verificação foi enviado com sucesso',
    ],
    'bkash' => [
    ...
    'affiliate' => [
        ...
        'manage_affiliates' => 'Gerir Afiliados',
        ...
        'affiliate_commission_release_in_days_help' => 'Número de dias após a entrega antes de a comissão de afiliado ser libertada para a carteira. Defina 0 ou deixe vazio para libertar quando a encomenda for entregue. Use um número positivo para um período de retenção após a entrega. Os administradores podem libertar manualmente a qualquer momento.',
        'affiliate_commission_release_direct_help' => 'As comissões de afiliado são creditadas na carteira do afiliado imediatamente quando a encomenda é entregue (encomendas pagas). Sem período de espera ou tarefa agendada.',
        ...
        'successfully_registered_as_affiliate' => 'A sua conta de afiliado foi criada. Por favor, inicie sessão.',
        'registration_failed' => 'Não foi possível criar a conta de afiliado. Tente novamente.',
        'name_required' => 'Introduza o seu nome.',
        'email_required' => 'Introduza o seu email.',
        'email_invalid' => 'Introduza um email válido.',
        'email_already_registered' => 'Este email já está registado como afiliado.',
        'password_required' => 'Introduza uma palavra-passe.',
        'password_min' => 'A palavra-passe deve ter pelo menos 6 caracteres.',
        'password_confirmation_mismatch' => 'A confirmação da palavra-passe não coincide.',
        ...
        'visitors' => 'Visitantes',
        'commission_rate' => 'Taxa de comissão',
        'link_already_exists' => 'Já tem um link curto para este produto.',
        'store' => 'Loja',
        'product' => 'Produto',
        'select_store' => 'Selecione uma loja',
        'select_store_first' => 'Selecione primeiro uma loja',
        'select_product' => 'Selecione um produto',
        'loading_products' => 'A carregar produtos...',
        'no_products_for_store' => 'Esta loja não tem produtos elegíveis para marketing de afiliados.',
        'products_load_failed' => 'Não foi possível carregar os produtos. Tente novamente.',
        'product_not_in_store' => 'Esse produto não pertence à loja selecionada.',
        'product_has_no_commission' => 'Este produto não paga comissão de afiliado.',
        'product_not_eligible' => 'Este produto não é elegível para marketing de afiliados.',
        'affiliate_enabled' => 'Elegível para marketing de afiliados',
        'help_affiliate_enabled' => 'Todos os produtos são elegíveis por predefinição. Desmarque para desativar links e comissões de afiliado neste item.',
        'store_email' => 'Email',
        'store_address' => 'Morada',
        'store_email_unavailable' => 'Email não disponível',
        'store_address_unavailable' => 'Morada não disponível',
        'short_link' => 'Link curto',
        'short_link_help' => 'Será criado um link curto único para este produto. Conta o último link clicado, e só se o cliente comprar em 7 dias. Depois desses 7 dias a afiliação termina. Um novo clique inicia outros 7 dias e pode gerar comissão outra vez.',
        'attribution_window' => 'O último clique vence. A comissão é paga uma vez em cada janela de 7 dias. Quando essa janela termina, um novo clique de afiliado inicia outros 7 dias e o afiliado pode ganhar outra vez.',
    ],
    'dynamic-currency' => [
    ...
    'shopify' => [
        ...
        'imported_from_shopify' => 'Isto foi importado do Shopify',
    ...
    'auction' => [
        ...
        'auction_running' => 'Em curso',
        'auction_paused' => 'Em pausa',
        'auction_ended' => 'Ended',
        'auction_ended_at' => 'Auction ended at',
        'auction_suspended' => 'Suspenso',
        ...
        'mins' => 'mins',
        'sec' => 'sec',
        'place_bid' => 'Faça a sua licitação',
        ...
        'bid_wins_at' => 'A licitação ganha a',
    ...
    'smartForm' => [
        ...
        'form_data_requied_validation_msg' => 'Envie todos os dados obrigatórios.',
    ],
    'wholesale' => [
    ...
    'buyer_group_required' => 'Tem de selecionar um grupo de compradores para se registar',
