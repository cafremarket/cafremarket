...
return [
    'wallet' => [
        ...
        'required_when_mpesa' => 'required when paying with M-Pesa',
        'required_when_emola' => 'required when paying with eMola',
        ...
        'platform_fees_updated' => 'Payout fee settings have been updated.',
        'platform_fees_section_help' => 'Withdrawal / payout fee when a vendor is paid out. Sale fees (transaction fee and marketplace commission) are set on each subscription plan.',
        'sales_fees_from_subscription_help' => 'Order fees use the vendor\'s <strong><a href=":url">subscription plan</a></strong>: <strong>Transaction fee</strong> (flat, charged to the customer on M-Pesa / eMola) and <strong>Marketplace commission</strong> (% deducted from the vendor when the sale is credited). Each shop must have an active plan assigned under Billing.',
        'vendor_sales_require_subscription' => 'This shop cannot accept orders until the vendor selects a subscription plan (Account → Billing).',
        'sales_commission_on_sale_note' => 'Marketplace commission is deducted when each paid order is credited to the vendor wallet (from the shop\'s subscription plan). Not charged again on withdrawal.',
        'platform_fee_enabled' => 'Enable fee',
        'platform_fee_type' => 'Fee type',
        'platform_fee_type_flat' => 'Flat amount (MZN)',
        'platform_fee_type_percent' => 'Percentage (%)',
        'platform_fee_value' => 'Fee value',
        'platform_fee_mpesa_customer' => 'M-Pesa — gateway part of transaction fee (customer)',
        'platform_fee_emola_customer' => 'eMola — gateway part of transaction fee (customer)',
        'platform_fee_mpesa_vendor' => 'M-Pesa — gateway part of marketplace commission (vendor)',
        'platform_fee_emola_vendor' => 'eMola — gateway part of marketplace commission (vendor)',
        'platform_fee_payout_vendor' => 'Vendor payout fee',
        'platform_fee_withdrawal_vendor' => 'Withdrawal fee (vendor)',
        'payout_fee_auto_help' => 'Pre-filled from settings when payout fee is enabled. You can change it before approving.',
        'payout_sales_commission_already_deducted' => 'Marketplace commission is deducted from each sale when it is credited to your wallet. Withdrawals use your available balance only.',
        'payout_approval_fee_help' => 'Optional transfer fee only. Sales commission is already deducted on each order payment — leave 0 unless you charge a separate payout/transfer fee.',
        'wallet_topup_fee_summary' => 'Payment summary',
        'wallet_topup_credit_amount' => 'Wallet credit',
        'wallet_topup_platform_fee' => 'Transaction fee',
        'wallet_topup_total_charge' => 'You will pay (M-Pesa / eMola)',
        'wallet_topup_fee_help' => 'The transaction fee (gateway) is added to your mobile payment. Your wallet is credited with the amount you enter above.',
        'checkout_payment_fee_summary' => 'Payment summary',
        'checkout_order_total' => 'Order total',
        'checkout_you_will_pay' => 'You pay (M-Pesa / eMola)',
        'checkout_mobile_pay_amount' => 'You pay (M-Pesa / eMola)',
        'checkout_customer_platform_fee' => 'Transaction fee',
        'checkout_vendor_platform_fee' => 'Marketplace commission',
        'checkout_vendor_receives' => 'Seller receives in wallet',
        'checkout_seller_platform_fee' => 'Marketplace commission (deducted from seller)',
        'checkout_platform_fee_help' => 'On M-Pesa or eMola you pay the order total plus the transaction fee (subscription plan fee + mobile gateway fee). The seller is charged marketplace commission (plan % + gateway fee) when the order is paid into their wallet.',
        'checkout_platform_fee_help_customer' => 'On M-Pesa or eMola you pay the order total plus any transaction fee.',
        'payment_method_fee_admin_title' => 'Where transaction fees are configured',
        'payment_method_fee_admin_checkout' => 'Checkout (M-Pesa / eMola) sale fees come from each vendor\'s <a href=":url">subscription plan</a> (flat or percent). Multi-vendor carts combine fees per shop.',
        'payment_method_fee_admin_topup' => 'Cafre-pay / wallet top-up fees are set under <a href=":url">Wallet settings</a> (M-Pesa / eMola gateway fees).',
        'checkout_vendor_fee_help' => 'Marketplace commission and mobile gateway fees are deducted from this sale when the order is credited to your wallet.',
        ...
        'payout_mobile_number' => 'Mobile number',
        'payout_mobile_help' => 'Use the number registered with M-Pesa or eMola (e.g. 258XXXXXXXXX).',
        'payout_account' => 'Payout account',
        'payout_account_registered' => 'Your registered payout account',
        'payout_account_not_registered' => 'Not registered yet (set on the first withdrawal request)',
        'payout_account_locked_help' => 'For security, all withdrawals are sent to this account and it cannot be changed from your panel. To change it, contact support.',
        'payout_account_contact_support' => 'Contact support',
        'payout_account_first_time_notice' => 'Double-check these details. This account will be saved as your fixed payout account and every future withdrawal will be sent to it. Only support can change it later.',
        'payout_account_locked_since' => 'Locked since :date',
        'payout_account_reset' => 'Reset payout account',
        'payout_account_reset_help' => 'Only do this after the vendor has requested and verified the change through support. The next withdrawal will register the new account.',
        'payout_account_reset_done' => 'The payout account for :shop has been reset. The next withdrawal request will register the new account.',
        'payout_mobile_invalid' => 'Enter a valid :method number starting with :prefixes (e.g. 258XXXXXXXXX).',
        'payout_saved_instruction' => 'Saved payout details',
        'payout_commission_summary' => 'Payout summary',
        'payout_requested_amount' => 'Amount you request',
        'payout_marketplace_commission' => 'Marketplace commission',
        'payout_total_wallet_debit' => 'Total deducted from wallet',
        'payout_commission_help' => 'The marketplace commission is charged when the admin approves this payout, in addition to the amount you request.',
        'sale_credit_after_commission' => 'Sale :order (platform fees :commission deducted — net credited to your wallet)',
        'wallet_topup_complete_charge' => 'Complete the payment on your phone for :total (includes :fee platform fee). Your wallet will be credited with :credit.',
        ...
        'deposit_description' => 'Deposit into Cafre-pay using :payment_method',
        ...
        'all_active_wallets' => 'All active wallets',
        'with_balance' => 'With balance',
        'all_types' => 'All types',
        'topup_wallet' => 'Top up wallet',
        'create_wallet' => 'Create wallet',
        'create_wallet_help' => 'Create a Cafrepay wallet for a customer or store using their email. If a wallet already exists, it will be reused.',
        'create_wallet_success' => 'Wallet ready for :owner (balance :balance).',
        'wallet_logs' => 'Wallet logs',
        'wallet_topup_fees_section' => 'Wallet top-up gateway fees',
        'wallet_topup_fees_help' => 'When a customer or merchant adds money via M-Pesa or eMola, charge this fee on top of the deposit amount (configured below). Marketplace commission on sales is set on each subscription plan.',
        'platform_fee_mpesa_topup' => 'M-Pesa wallet top-up fee',
        'platform_fee_emola_topup' => 'eMola wallet top-up fee',
        'admin_topup_description' => 'Manual top-up by admin',
        'admin_topup_success' => 'Wallet topped up successfully.',
        'search_wallet' => 'Search by name or email',
        ...
        'poll_timeout_error' => 'Payment was not confirmed in time. If you have already paid, your balance will update when we receive the confirmation. Otherwise please try again or contact support.',
        ...
        'my_wallet' => 'My Cafrepay',
        'wallet' => 'Cafrepay',
        'pay_by_wallet' => 'Pay with Cafrepay wallet balance.',
        ...
        'payout_payment_proof' => 'Payment proof',
        'payout_payment_proof_help' => 'Upload a receipt or transfer confirmation (JPG, PNG, or PDF, max 10 MB).',
        'payout_payment_proof_required' => 'Please upload payment proof before approving the payout.',
        'payout_payment_proof_mimes' => 'Payment proof must be a JPG, PNG, or PDF file.',
        'payout_payment_proof_download' => 'Download proof',
        'payout_fee' => 'Payout fee',
        'payout_fee_may_apply' => 'A payout fee may apply from :platform',
        'platform_fee' => 'Transaction fee',
    ...
    'subscription' => [
        ...
        'subscription_fee' => 'Subscription fee for :subscription plan.',
    ...
    'affiliate' => [
        ...
        'affiliate_commission_release_in_days_help' => 'Number of days after delivery before affiliate commission is released to the affiliate wallet. Set 0 or leave empty to release when the order is delivered. Use a positive number for a holding period after delivery. Admins can still release manually anytime.',
        'affiliate_commission_release_direct_help' => 'Affiliate commissions are credited to the affiliate wallet immediately when the order is delivered (paid orders). No waiting period or scheduled job.',
        ...
        'successfully_registered_as_affiliate' => 'Your affiliate account was created. Please log in.',
        'registration_failed' => 'We could not create your affiliate account. Please try again.',
        'name_required' => 'Please enter your name.',
        'email_required' => 'Please enter your email address.',
        'email_invalid' => 'Please enter a valid email address.',
        'email_already_registered' => 'This email is already registered as an affiliate.',
        'password_required' => 'Please enter a password.',
        'password_min' => 'Password must be at least 6 characters.',
        'password_confirmation_mismatch' => 'Password confirmation does not match.',
        'terms_required' => 'Please accept the terms to create an account.',
        ...
        'visitors' => 'Visitors',
        'commission_rate' => 'Commission rate',
        'link_already_exists' => 'You already have a short link for this product.',
        'store' => 'Store',
        'product' => 'Product',
        ...
        'no_products_for_store' => 'This store has no products eligible for affiliate marketing.',
        'products_load_failed' => 'Could not load products. Please try again.',
        'product_not_in_store' => 'That product does not belong to the selected store.',
        'product_has_no_commission' => 'This product does not pay an affiliate commission.',
        'product_not_eligible' => 'This product is not eligible for affiliate marketing.',
        'affiliate_enabled' => 'Eligible for affiliate marketing',
        'help_affiliate_enabled' => 'All products are eligible by default. Uncheck to disable affiliate links and commissions for this item.',
        'store_email' => 'Email',
        'store_address' => 'Address',
        'store_email_unavailable' => 'Email not available',
        'store_address_unavailable' => 'Address not available',
        'short_link' => 'Short link',
        'short_link_help' => 'A unique short link for this product will be created. The last affiliate link the customer clicked is the one that counts, and only if they buy within 7 days. After those 7 days the affiliation ends. A new click starts another 7 days and can earn commission again.',
        'attribution_window' => 'Last click wins. Commission is paid once in each 7-day window. When that window ends, a new affiliate click starts another 7 days and the affiliate can earn again.',
    ],
    'dynamic-currency' => [
