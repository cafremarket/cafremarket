...
return [
    ...
    'payment_method_disconnect_failed' => 'This application is not connected to the payment account, or the account does not exist.',
    ...
    'billing_setup_unavailable' => 'Card billing is not available. Subscriptions are billed from wallet balance using M-Pesa or eMola.',
    ...
    'notice' => [
        ...
        'wire_transfer_rejection_reason_placeholder' => 'e.g. Amount doesn\'t match the order total, or the receipt is unreadable — the customer will see this note.',
    ],
    ...
    'your_shop_in_hold' => 'Your shop is on hold! We will review and approve your shop as soon as possible!',
    ...
    'review_delete_request_pending' => 'A deletion request for this review is already pending admin review.',
    'review_delete_request_not_pending' => 'This deletion request is no longer pending review.',
    'review_delete_request_approved' => 'The review has been deleted.',
    'review_delete_request_rejected' => 'The deletion request has been rejected.',
    ...
    'subscription_module_disabled' => 'Subscription module is not enabled!',
    'no_valid_active_products_selected' => 'No valid active products selected.',
    'push_campaign_saved_draft' => 'Push campaign saved as draft.',
    'push_campaign_edit_not_allowed' => 'Only draft or failed campaigns can be edited.',
    'push_campaign_update_not_allowed' => 'Only draft or failed campaigns can be updated.',
    'push_campaign_updated' => 'Push campaign updated.',
    'push_campaign_deleted' => 'Push campaign deleted.',
    'push_campaign_queued' => 'Push campaign queued. It will send shortly.',
    'dispute_ticket_exists' => 'A dispute ticket already exists for this order.',
    'dispute_only_admin_can_close' => 'Only marketplace admin can close a dispute ticket.',
    'dispute_mark_resolved_first' => 'Mark the dispute as resolved before requesting admin to close it.',
    'dispute_ticket_closed' => 'This dispute ticket is closed. Only marketplace admin can close tickets, and it cannot be updated after close.',
    'chat_reply_not_allowed' => 'Not allowed to reply',
    'conversation_not_found' => 'Conversation not found',
    'empty_message' => 'Empty message',
    'conversation_no_customer' => 'This conversation has no customer to bill',
];
