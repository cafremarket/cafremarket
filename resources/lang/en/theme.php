...
return [
    ...
    'emola_code_invalid_amount' => 'Invalid amount for eMola. Use a whole number in Meticals (MZN). Order payments: up to :max MZN per transaction; wallet top-ups: up to 1,000 MZN.',
