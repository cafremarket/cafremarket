...
return [
    ...
    'emola_error_06' => 'Invalid amount for eMola. Use a whole number in Meticals (MZN). Order payments: up to :max MZN per transaction; wallet top-ups: up to 1,000 MZN.',
    ...
    'emola_error_11' => 'Payment was cancelled on your phone (PIN not entered). The order is not paid — you can try again.',
