...
return [
    ...
    'emola_code_invalid_amount' => 'eMola could not accept :amount MZN (allowed: 1–:movitel_max MZN per USSD request). Check the order total and try again.',
    ...
    'emola_code_msisdn_not_whitelisted' => 'This eMola number is not allowed for payments yet. Ask Movitel to whitelist it for your merchant account (partner code), or use a number they have already registered for testing.',
    'emola_code_pin_cancelled' => 'Payment was cancelled on your phone (PIN not entered). The order is not paid — you can try again.',
