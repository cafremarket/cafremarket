...
return [
    ...
    'emola_code_invalid_amount' => 'Invalid amount for eMola. Use a whole number in Meticals (MZN).',
    'emola_amount_too_long' => 'Amount is too large for the eMola USSD field (maximum 5 digits per request).',
