...
return [
    ...
    'web_banners_intro' => 'Manage the promotional banner rows shown on the public storefront homepage (below the hero slider). Use Group 1, 2 and 3 for the three homepage rows. Banners are grouped by row; adjust column width (out of 12) to show multiple banners side by side.',
    'web_banner_form_note' => 'These banners appear on the website homepage only (not in the mobile app merchant shops).',
    'web_banner_columns_hint' => 'Use 12 for full width, 6 for half, 4 for three per row, etc.',
    'web_banner_group_group_1' => 'Homepage row 1',
    'web_banner_group_group_1_hint' => 'First banner row on the homepage.',
    'web_banner_group_group_2' => 'Homepage row 2',
    'web_banner_group_group_2_hint' => 'Second banner row on the homepage.',
    'web_banner_group_group_3' => 'Homepage row 3',
    'web_banner_group_group_3_hint' => 'Third banner row on the homepage.',
    'web_banner_group_group_4' => 'Extra row 4',
    'web_banner_group_group_4_hint' => 'Optional placement (not used on default homepage).',
    'web_banner_group_group_5' => 'Extra row 5',
    'web_banner_group_group_5_hint' => 'Optional placement (not used on default homepage).',
    'web_banner_group_group_6' => 'Extra row 6',
    'web_banner_group_group_6_hint' => 'Optional placement (not used on default homepage).',
