...
return [
    ...
    'subscription_plan_id' => 'A unique identifier for this subscription plan.',
    ...
    'policy_pages_intro' => 'Edit legal and policy content here once. Changes apply to the website and all mobile apps (Customer, Vendor, Delivery) through the shared page API. Empty or placeholder pages automatically fall back to built-in default content until you publish your own.',
    'policy_page_placeholder_warning' => 'This page still has placeholder or empty content. Mobile apps and the website currently serve built-in default policy text. Click “Apply default content” to save that template into the CMS, or paste your own legal copy.',
    'policy_page_slug_locked' => 'Slug is locked so Web and Apps keep resolving the same URL / API path.',
    'policy_apply_defaults' => 'Replace this page’s content with the built-in default policy template (uses your marketplace name and support email).',
    'policy_apply_all_defaults' => 'Fill every empty or placeholder policy page with the built-in default templates.',
    ...
    'seller_type' => 'Choose whether you sell as an individual person or as a registered company.',
    'seller_type_individual' => 'You sell in your own name. Verification needs your ID and photo only.',
    'seller_type_company' => 'You sell as a registered business. Verification needs your ID plus company documents.',
    'nuit' => 'Your NUIT (tax identification number). Required for both individual and company sellers.',
    ...
    'attribute_presets_hint' => 'Tip: use presets like Colour, Size, Material. After saving, add option values (e.g. Red, M, Cotton) from the Entities screen.',
    'attribute_presets_available' => 'Presets ready: Colour, Size, Material, Style, Gender, Storage.',
    'product_attributes' => 'Select attributes used by this product (Colour, Size, etc.). They will be available when creating variants.',
    'product_attributes_manage' => 'Need more options? Manage attributes here:',
    'product_variant_fields' => 'For each attribute combination you can set image, SKU, stock quantity and sale price. Each combination is saved as a separate inventory listing.',
    'product_attributes_tab_intro' => 'Pick attributes for this product, choose option values, then generate variants. Every variant gets its own inventory SKU, stock, price and image.',
    'catalog_attributes_tab_intro' => 'Attach attributes to this product. To create separate SKUs for each Colour/Size combination, use Add Product with Inventory.',
    'base_pricing_when_no_variants' => 'If this product has no variants, the SKU, sale price and stock from Basic Info are used. Add attributes only when you need multiple options (e.g. Colour + Size), each with its own SKU and price.',
    'optional_variants_hint' => 'Skip this section for a simple product. Use it only when customers must choose options — then each combination gets its own inventory SKU, price and image.',
    'woo_product_editor_intro' => 'Add name, price, and stock in one place. Switch to Variable product only if you need Colour, Size, or other options.',
    'woo_simple_pricing' => 'Regular price and sale price apply to this product. No attributes needed.',
    'woo_variable_pricing' => 'Regular price and stock here are defaults for new variants only. When you generate attributes, each option gets its own SKU — the base product is not saved as a separate SKU. Pick which combination is Default in the variants table.',
    'variant_pricing_overrides_base' => 'Each variant row has its own sale price and stock. Those values are used instead of the base product price for that option.',
    'pricing_and_stock_intro' => 'Set the main SKU, sale price and stock here. For products with Colour/Size variants, you can override price per combination on the Attributes & Variants tab.',
    'attributes_on_next_tab' => 'Manage Colour, Size and other variants on the Attributes & Variants tab.',
    'select_category_or_attributes' => 'Select categories on Basic Info, or choose attributes above, then load options.',
    'each_variant_own_inventory' => 'Each row is a separate inventory with its own SKU',
    'default_variant_selection' => 'Mark one combination as Default. That variant becomes the main listing (product card). Other combinations are options on the product page — the main/base SKU is not counted separately when attributes are used.',
    'edit_variants_via_inventory' => 'To change SKU, stock, price or image for a variant, open inventory edit or:',
    'no_variants_yet_use_inventory_product' => 'No variants yet. Use “Add product with inventory” to generate Colour/Size combinations, each with its own SKU and stock.',
    ...
    'warehouse_stock_matrix' => 'Set on-hand quantity per warehouse. Listing stock is the sum across warehouses. Reorder level overrides the shop alert quantity when set.',
    'stock_overview_intro' => 'Live stock across products and warehouses — adjust, transfer, and catch low stock before it sells out.',
    'stock_overview_empty' => 'No inventory matches these filters. Add a product or clear filters to see stock here.',
    ...
    'refund_requires_approval' => 'Refunds stay Pending until an admin Approves or Rejects them. Wallet transfer happens only on Approve.',
    ...
    'popup_platform' => 'Where this popup is allowed to appear: website, mobile app, or both.',
    'popup_page' => 'Which page this popup is targeted to. "All" matches every page.',
    'popup_frequency' => 'How often a visitor sees this popup again after closing it.',
    'popup_priority' => 'When more than one popup matches at once, the lowest number is shown.',
    'popup_hide_text' => 'When Yes, only the popup image is shown (headline, description, and button are hidden).',
    ...
    'web_banners_intro' => 'Three homepage rows. Choose banner type (slider, single image, or colour) and layout (full width or 3 per row).',
    'web_banners_homepage_section' => 'These three rows appear on the public homepage under the hero slider.',
    'web_banners_extra_section' => 'Optional rows kept for custom layouts. They are not shown on the default homepage.',
    'web_banner_form_note' => 'These banners appear on the website homepage only (not in the mobile customer app).',
    'app_banners_intro_title' => 'Customer app banner rows',
    'app_banners_intro' => 'Three rows for the customer mobile app homepage. Managed separately from web banners.',
    'app_banners_section' => 'These rows appear on the customer app home screen under the hero slider.',
    'app_banner_form_note' => 'These banners appear in the customer mobile app only (not on the website homepage).',
    'web_banner_columns_hint' => 'Full width = 1 banner. 3 per row = up to three banners side by side.',
    'web_banner_width_full' => 'Full width',
    'web_banner_width_half' => 'Half width',
    'web_banner_width_third' => 'One third',
    'web_banner_width_quarter' => 'One quarter',
    'web_banner_layout_full' => 'Full width',
    'web_banner_layout_third' => '3 banners per row',
    'web_banner_layout' => 'Full width spans the page. 3 per row places banners side by side (use width 4 for each).',
    'web_banner_display_type' => 'Slider rotates all banners in this row. Single image shows a static photo. Colour uses a solid background (image optional).',
    'web_banner_colour' => 'Background colour for colour-based banners.',
    'web_banner_guide_slider' => 'Rotating carousel — add multiple banners in the same row',
    'web_banner_guide_single' => 'Static image banner',
    'web_banner_guide_colour' => 'Solid colour block with optional text',
    'web_banner_guide_full' => 'One banner across the page',
    'web_banner_guide_third' => 'Up to three banners in one row',
    'web_banner_tips_title' => 'Quick tips',
    'web_banner_tip_row' => 'Use only Homepage row 1–3.',
    'web_banner_tip_type' => 'Pick Slider, Single image, or Colour based. Keep the same type for banners in one row.',
    'web_banner_tip_width' => 'Layout: Full width, or 3 banners per row.',
    'web_banner_tip_order' => 'Lower position numbers appear first in the row (or slide order).',
    'web_banner_tip_image' => 'Upload a wide image; recommended around 1200×400px or larger.',
    'web_banner_tip_image_optional' => 'Image is optional for colour banners. Colour fills the background.',
    'web_banner_hide_text' => 'When Yes, only the banner image/colour is shown on the storefront (title, description, and button text are hidden).',
    'web_banner_group_group_1' => 'Homepage row 1',
    'web_banner_group_group_1_hint' => 'First banner strip under the hero.',
    'web_banner_group_group_2' => 'Homepage row 2',
    'web_banner_group_group_2_hint' => 'Second banner strip on the homepage.',
    'web_banner_group_group_3' => 'Homepage row 3',
    'web_banner_group_group_3_hint' => 'Third banner strip on the homepage.',
    'web_banner_group_group_4' => 'Extra row 4',
    'web_banner_group_group_4_hint' => 'Optional — not used on the default homepage.',
    'web_banner_group_group_5' => 'Extra row 5',
    'web_banner_group_group_5_hint' => 'Optional — not used on the default homepage.',
    'web_banner_group_group_6' => 'Extra row 6',
    'web_banner_group_group_6_hint' => 'Optional — not used on the default homepage.',
    ...
    'can_use_own_catalog_only' => 'When enabled, vendors can only list products from their own catalog, not from the shared marketplace catalog.',
    'can_cancel_order_within' => 'How long after placing an order a customer may still cancel it without the seller\'s approval.',
    'show_social_auth' => 'Show social login buttons (Google, Facebook, etc.) on the customer login and registration forms.',
    'max_img_size_limit_kb' => 'Maximum size allowed for each uploaded image, in kilobytes.',
    'address_show_map' => 'Show a map on address forms so users can pin their exact location.',
    'address_show_country' => 'Show the country field on address forms. Hide it if you only operate in one country.',
    'shop_default_shipping' => 'Shop default shipping. Products can override this.',
    'push_campaign_image' => 'HTTPS image recommended for rich notifications on Android/iOS.',
    'deal_calendar_intro' => 'Plan multiple products per day. Select store, tick products, save.',
    'inventory_shipping_override' => 'Override shop default. Cart uses the highest shipping amount among products.',
    'banner_bg_deprecated' => 'The background color and image has no use in new default theme and will be removed in future update.',
    'featured_products_intro' => 'Curated products for the homepage Featured section.',
    'featured_products_pick' => 'Pick a store first, then choose products from that store (one listing per product).',
    'custom_order_intro' => 'Search your own catalog for real pricing, or add a one-off custom item — every field below is editable.',
    'custom_order_payment_note' => 'The customer picks their own payment method and pays once they open this order — no need to choose one here.',
    'customer_no_saved_address' => 'This customer has no saved address yet — type the billing address below.',
    'pick_customer_to_reply' => 'Pick a customer on the left to reply in real time.',
    'no_fcm_credentials' => 'No FCM credentials configured. Add Firebase service account JSON files under <code>storage/app/firebase/</code> or set <code>FCM_TOKEN_CUSTOMER</code> / <code>FCM_TOKEN_VENDOR</code> in <code>.env</code>.',
    'live_shipping_rates_intro' => 'Enhance your customer experience by offering live shipping cost calculations. Keep your customers informed and satisfied with accurate shipping information.',
];
