...
return [
    ...
    'web_banners_intro' => 'Drag your eye down the page: each row below mirrors a banner strip on the storefront. Add banners to a row, set width (out of 12), and order. Groups 1–3 show on the homepage.',
    ...
    'web_banner_columns_hint' => 'Widths in a row should add up to 12 (or less). Example: 6 + 6, or 4 + 4 + 4.',
    ...
    'web_banner_tip_row' => 'Pick Homepage row 1–3 for live homepage placement.',
    'web_banner_tip_width' => 'Use full (12), half (6), or thirds (4) so banners sit side by side.',
    'web_banner_tip_order' => 'Lower position numbers appear first in the row.',
    'web_banner_tip_image' => 'Upload a wide image; recommended around 1200×400px or larger.',
    'web_banner_hide_text' => 'When Yes, only the banner image is shown on the storefront (title, description, and button text are hidden).',
