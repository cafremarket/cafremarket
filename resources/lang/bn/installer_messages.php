<?php 
return [
  'old_installation_has_data' => 'আপনার ডাটাবেস খালি না! হয়তো আপনার পূর্ববর্তী ইনস্টলেশন থেকে কিছু তথ্য অবশিষ্ট আছে। নতুন ইনস্টলেশনের জন্য, আপনাকে আপনার ডাটাবেস খালি করতে হবে এবং লাইসেন্সটি পুনরায় ইনস্টল করতে হবে। পুরানো ডেটা রাখতে আপনি লগইন পৃষ্ঠায় যেতে পারেন। এছাড়াও আপনি ডেমো ডেটা নতুন করে আমদানি করতে পারেন।',
  'title' => 'cafremarket ইনস্টলার',
  'next' => 'পরবর্তী পর্ব',
  'back' => 'আগে',
  'finish' => 'ইনস্টল করুন',
  'forms' => [
  ...
  'environment' => [
    ...
    'wizard' => [
      ...
      'form' => [
        ...
        'app_environment_label_development' => 'উন্নয়ন',
        ...
        'app_tabs' => [
          ...
          'pusher_app_id_placeholder' => 'পুশার অ্যাপ আইডি',
          'pusher_app_key_label' => 'পুশার অ্যাপ কী',
          'pusher_app_key_placeholder' => 'পুশার অ্যাপ কী',
          'pusher_app_secret_label' => 'পুশার অ্যাপ সিক্রেট',
          'pusher_app_secret_placeholder' => 'পুশার অ্যাপ সিক্রেট',
        ],
        'buttons' => [
  ...
  'installed' => [
    'success_log_message' => 'cafremarket ইনস্টলার সফলভাবে ইনস্টল করা আছে',
  ],
  'final' => [
    'title' => 'শেষ ধাপ',
  ...
  'updater' => [
    ...
    'log' => [
      'success_message' => 'cafremarket ইনস্টলার সফলভাবে UPDATED চালু',
    ],
  ],
];