...
<body>
  @php
      ...
      if (! is_array($invoice_from)) {
          $invoice_from = $invoice_from === '' || $invoice_from === null ? [] : [(string) $invoice_from];
      }
...
@endphp
    <div style="width:100%">
      ...
      <div style="float:right; text-style:uppercase">
        <div style="font-size: 1.5rem">@lang('packages.affiliate.affiliate_commission')</div>
    ...
    <div style="width:100%;">
      <div style="float:left; width: 45%;">
        <span style="color:#007fff">@lang('packages.affiliate.commission_from')</span>
        <hr style="color:#007fff">
        @foreach ($invoice_from as $address_line)
          @if (filled($address_line))
            {{ $address_line }}<br>
          @endif
        @endforeach
      </div>
      <div style="float:right; width: 45%">
        <span style="color:#007fff">@lang('packages.affiliate.commission_to')</span>
        <hr style="color: #007fff">
