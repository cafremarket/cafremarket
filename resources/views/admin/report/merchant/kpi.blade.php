      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">
            {{ get_formated_currency($sales_total, 2, config('system_settings.currency.id')) }}
          </span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 nopadding-left">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">
            @if ($orders_count)
              {{ get_formated_currency($sales_total / $orders_count, 2, config('system_settings.currency.id')) }}
            @else
              0
            @endif
          </span>
          ...
          <table class="table table-default">
            <tbody>
              <tr>
                ...
                <td class="pull-right">{{ get_formated_currency($sales_total, 2, config('system_settings.currency.id')) }}</td>
              </tr>
              <tr>
                <td>{{ trans('app.discounts') }}</td>
                <td class="pull-right">-{{ get_formated_currency($discount_total, 2, config('system_settings.currency.id')) }}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="pull-right">
                  <span class="lead">{{ get_formated_currency($sales_total - ($discount_total + $latest_refund_total), 2, config('system_settings.currency.id')) }}</span>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <tbody>
            @foreach ($top_listings as $inventory)
              <tr>
                ...
                <td class="text-center">{{ get_formated_currency($inventory->gross_sales, 2, config('system_settings.currency.id')) }}</td>
                <td>&nbsp;</td>
              </tr>
            @endforeach
          </tbody>
              ...
              <tbody>
                @forelse($top_customers as $customer)
                  <tr>
                    ...
                    <td class="text-center">{{ get_formated_currency(round($customer->orders->sum('total')), 2, config('system_settings.currency.id')) }}</td>
                  </tr>
                @empty
                  <tr>
