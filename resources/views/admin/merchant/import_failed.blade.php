...
@section('content')
  ...
  @php
    $hiddenFields = '';
    foreach ($failed_rows as $row) {
      $hiddenFields .= '<input type="hidden" name="data[]" value="' . e(serialize($row[0]['data'])) . '">';
    }
  @endphp
  @include('admin.partials.ui.import_footer', [
    'cancelUrl' => route('admin.vendor.merchant.index'),
    'cancelClass' => 'btn-danger',
    'cancelLabel' => trans('app.dismiss'),
    'formRoute' => 'admin.vendor.merchant.downloadFailedRows',
