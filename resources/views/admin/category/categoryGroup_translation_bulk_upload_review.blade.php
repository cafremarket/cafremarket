...
@section('content')
  @include('admin.partials.ui.card_start', [
    'title' => trans('app.model_translations_bulk_upload', ['model' => trans('app.model.category_group')]) . ' — ' . trans('app.preview'),
    'icon' => 'fa-folder',
  ...
  @include('admin.partials.ui.import_footer', [
    ...
    'rowCount' => count($rows),
    'formRoute' => 'admin.catalog.categoryGroup.translate.bulk.import',
