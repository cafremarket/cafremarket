...
<div class="form-group">
  ...
  {!! Form::text('name', null, ['class' => 'form-control makeSlug', 'placeholder' => trans('app.placeholder.subcategory_name'), 'required']) !!}
  <div class="help-block with-errors"></div>
</div>
...
<div class="form-group">
  {!! Form::label('featured', trans('app.featured')) !!}
  {!! Form::checkbox('featured', 1, null, ['class' => 'icheck']) !!}
</div>
...
<div class="row">
  <div class="col-md-6 nopadding-right">
    <div class="form-group" style="margin-bottom: 0px!important;">
      ...
      @if (isset($subCategory) && $subCategory->coverImage)
        <img src="{{ get_storage_file_url(optional($subCategory->coverImage)->path, 'small') }}" width="" alt="{{ trans('app.cover_image') }}">
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      ...
      @if (isset($subCategory) && $subCategory->featureImage)
        <img src="{{ get_storage_file_url(optional($subCategory->featureImage)->path, 'small') }}" width="" alt="{{ trans('app.featured_image') }}">
        <span style="margin-left: 10px;">
