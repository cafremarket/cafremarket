<div class="modal-dialog modal-md">
  <div class="modal-content">
    {!! Form::open(['route' => 'admin.catalog.subcategory.translate.bulk.upload', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
    ...
    <ul>
        ...
        <li>{!! trans('help.download_template', ['url' => route('admin.catalog.subcategory.translate.download.template')]) !!}</li>
        <li>{!! trans('help.first_row_as_header') !!}</li>
        <li>{!! trans('help.required_fields_csv', ['fields' => 'slug, lang, name']) !!}</li>
    ...
    <div class="row">
        ...
        <div class="fileUpload btn btn-primary btn-block btn-flat">
            ...
            <input type="file" name="subCategoryTranslations" id="uploadBtn" class="upload" />
        </div>
        </div>
    </div>
    </div>
