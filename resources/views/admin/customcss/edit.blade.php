        ...
        <div class="col-md-7">
          ...
          @else
            ...
            <div class="form-group">
              ...
              {!! Form::textarea('theme_custom_css', get_from_option_table('theme_custom_styling' . \Auth::user()->shop_id, ''), ['class' => 'form-control', 'rows' => '10', 'placeholder' => trans('help.custom_css_help_text')]) !!}
