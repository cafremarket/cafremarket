      ...
      <div class="row">
        <div class="col-md-6 nopadding-right">
          <div class="form-group">
            ...
            @if (isset($shop) && $shop->logoImage?->path && Storage::exists($shop->logoImage->path))
              <label>
                <img src="{{ get_storage_file_url($shop->logoImage->path, 'small') }}" alt="{!! $shop->name !!}">
        ...
        <div class="col-md-6 nopadding-left">
          <div class="form-group">
            ...
            @if (isset($shop) && $shop->coverImage?->path && Storage::exists($shop->coverImage->path))
              <label>
                <img src="{{ get_storage_file_url($shop->coverImage->path, 'small') }}" alt="{!! $shop->name !!}">
                <span style="margin-left: 10px;">
