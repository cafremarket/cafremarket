  ...
  <div class="modal-content">
    <div class="modal-body" style="padding: 0px;">
      ...
      <div class="col-md-12 nopadding" style="margin-top: 10px;">
        @if ($attributeValue->featureImage)
          <img src="{{ get_storage_file_url(optional($attributeValue->featureImage)->path, 'medium') }}" class="thumbnail" width="100%" alt="{{ trans('app.image') }}">
