  ...
  <div class="col-md-8 nopadding-right">
    <div class="form-group">
      ...
      <div class="help-block with-errors">
        <small class="text-info"><i class="fa fa-info-circle"></i> {{ trans('help.you_can_use_span_tag') }}</small>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-md-6">
    <div class="form-group">
      ...
      @if (isset($slider) && $slider->featureImage?->path && Storage::exists($slider->featureImage->path))
        <div>
          <img src="{{ get_storage_file_url($slider->featureImage->path, 'medium') }}" width="50%" alt="{{ trans('app.slider_image') }}">
      ...
      <div class="help-block with-errors">
        {{ active_theme() == 'nova' ? trans('help.slider_img_hint_made_in_china') : trans('help.slider_img_hint') }}
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      ...
      @if (isset($slider) && $slider->mobileImage?->path && Storage::exists($slider->mobileImage->path))
        <div class="mb-2">
          <img src="{{ get_storage_file_url($slider->mobileImage->path, 'medium') }}" width="50%" alt="{{ trans('app.slider_image') }}">
