...
@section('content')
  @include('admin.partials.ui.card_start', [
    'title' => trans('app.model_translations_bulk_upload', ['model' => trans('app.model.manufacturer')]) . ' — ' . trans('app.preview'),
    'icon' => 'fa-industry',
  ...
  @include('admin.partials.ui.import_footer', [
    ...
    'rowCount' => count($rows),
    'formRoute' => 'admin.catalog.manufacturer.translate.bulk.import',
