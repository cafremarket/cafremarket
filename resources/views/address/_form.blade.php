@if ((isset($addressable_type) && $addressable_type == 'App\Models\Customer') || (isset($address) && $address->address_type != 'Primary'))
...
<div class="row">
  ...
  <div class="col-md-4 sm-padding">
    <div class="form-group">
      ...
      {!! Form::text('zip_code', null, ['class' => 'form-control', 'required', 'placeholder' => trans('app.placeholder.zip_code')]) !!}
    </div>
  </div>
